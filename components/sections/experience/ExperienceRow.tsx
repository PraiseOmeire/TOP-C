...
/**
 * One pillar of the Experience program index: a hairline rule, an Electric-Blue
 * kicker tag, a big title, and a line of copy. A pillar carrying `items` (Skill
 * Acquisition) expands into blue-ruled sub-cards — the section's quiet signature.
 * Presentational; the parent supplies the scroll-reveal motion.
 */
export function ExperienceRow({ pillar }: ExperienceRowProps) {
  return (
    <article className="border-t border-near-black/15 pt-8 lg:pt-10">
      <div className="grid gap-4 lg:grid-cols-12 lg:gap-10">
        ...
        <div className="lg:col-span-9">
          <h3 className="font-display text-4xl font-black uppercase leading-[0.95] tracking-tight text-near-black sm:text-5xl">
            {pillar.title}
          </h3>
